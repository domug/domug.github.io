...
2. **Use Bayes' Theorem to update prior based on the observed data**.
3. **Derive posterior**.

---

Let's follow these steps to derive the posterior analytically for our example. 
