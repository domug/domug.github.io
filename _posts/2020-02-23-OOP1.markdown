...
In fact, learning how to use class is the same as learning object-oriented programming (in short oop), as oop is like making a program that runs based on the "communication" between various classes.
